...
void write_power_spectrum_skyscuts_L4(double kmin, double kmax, double deltak_re0[], double deltak_im0[], double deltak_re2[], double deltak_im2[], double deltak_re4[], double deltak_im4[],  double Deltak, long int ngrid, double L1, double L2, double I22, int N_interlacing,char *name_ps_out, double P_shot_noise, char *binning_type);

void write_power_spectrum_periodic(double kmin, double kmax, double deltak_re[], double deltak_im[], double bin_ps, long int  ngrid, double L1, double L2, int Ninter, char *name_ps_out, double P_shot_noise, char *binning_type);
