...
void loop_directsum_yamamoto_skycut(double kmin,double kmax, double *pos_x, double *pos_y, double *pos_z, double *weight, long int Ndata2, double *pos_x_rand, double *pos_y_rand, double *pos_z_rand, double *weight_rand, long int Nrand2, double L1, double L2, int ngrid, double P_shot_noise, double bin_ps, double I22, double alpha, int n_lines_parallel, char *binning_type, char *Hexadecapole_type, char *name_ps_out);
